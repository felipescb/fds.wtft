...
},{"_css_loader":"../../../Users/F/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/css-loader.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
window.retrieveDMJson = function () {
  ...
  temp.className = 'icon';
  temp.href = 'data:' + data;
  temp.download = 'DM-DATA-' + getFormattedTime() + '.json';
...
var screenshot = function screenshot(element) {
  ...
  return (0, _html2canvas.default)(element, options).then(function (c) {
...
window.retrieveScreenshotDM = function () {
  window.scrollTo(0, 0);
  ...
  screenshot(element, {
    ...
    y: 0,
    height: element.scrollHeight + 100 // height: 900

  }).then(function (canvas) {
    var a = document.createElement('a');
    a.href = canvas.toDataURL("image/jpeg").replace("image/jpeg", "image/octet-stream");
    a.download = 'DM-' + getFormattedTime() + '.jpg';
    a.click();
  });
};
...
main();
},{"html2canvas":"node_modules/html2canvas/dist/html2canvas.js","./sass/main.scss":"sass/main.scss"}],"../../../Users/F/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "1510" + '/');
...
//# sourceMappingURL=/daily-manifest.e31bb0bc.js.map